...
const dataCategories = [
  ...
  {
    title: "와드 텍스트 및 분석 결과",
    body: "사진에서 인식된 와드 텍스트, 운동 방식, 동작, 라운드, 기록, 메모 등 사용자가 입력하거나 AI 분석을 통해 생성된 운동 관련 정보가 처리될 수 있습니다.",
  },
  {
    title: "기기 정보, 앱 사용 정보, 크래시 로그",
    body: "앱 버전, 운영체제 버전, 기기 모델, 언어/지역 설정, 앱 실행 및 기능 사용 기록, 오류 로그, 크래시 발생 시점의 진단 정보가 앱 안정성 개선을 위해 처리될 수 있습니다.",
  },
  {
    title: "광고 관련 정보",
  ...
  {
    title: "구매 정보",
    body: "인앱 결제 상품, 결제 상태, 구독 여부, 영수증 또는 거래 식별자 등 구매 확인에 필요한 정보가 처리될 수 있습니다. 신용카드 번호 등 결제 수단의 상세 정보는 앱이 직접 저장하지 않습니다.",
  },
];
...
const serviceProviders = [
  {
    ...
    purpose: "사용자가 선택한 와드 사진 또는 텍스트를 분석하고 구조화된 분석 결과를 생성하기 위해 사용됩니다.",
  },
  {
    name: "Google Cloud",
    purpose: "AI 분석 요청 처리, 서버 인프라 운영, 보안 및 서비스 안정성 유지를 위해 사용될 수 있습니다.",
  },
  {
    name: "AdMob",
  ...
  {
    name: "인앱결제 SDK",
    purpose: "유료 기능, 구독 또는 앱 내 구매의 결제 처리, 구매 상태 확인, 환불 및 결제 오류 대응을 위해 사용될 수 있습니다.",
  },
  {
    name: "Firebase",
    purpose: "크래시 분석, 앱 사용 분석, 성능 모니터링, 알림 또는 앱 안정성 개선을 위해 사용될 수 있습니다.",
  },
];
        ...
        <article className="policy-card">
          <section>
            ...
            <p>
              ...
              생성, 갤러리 저장, 광고 및 인앱 결제 기능을 이용하는 과정에서
              아래와 같은 데이터가 처리될 수 있습니다.
            </p>
            <p>
          ...
          <section>
            ...
            <ul>
              ...
              <li>
                <strong>결제 기능 제공:</strong> 유료 기능, 구독 또는 앱 내 구매
                이용 여부를 확인하고 결제 오류, 환불, 구매 복원 요청에 대응합니다.
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <p>
              Show Your Fit은 앱 기능 제공, 분석, 광고, 결제 및 안정성 개선을
              위해 아래 외부 서비스 또는 SDK를 사용할 수 있습니다. 이러한 서비스는
              각 기능 제공에 필요한 범위에서 데이터를 처리할 수 있으며, 처리되는
              데이터의 종류는 사용자가 실제로 이용하는 기능과 기기 설정에 따라
              달라질 수 있습니다.
            </p>
            <div className="policy-detail-list">
          ...
          <section>
            ...
            <ul>
              <li>
                ...
                위해 일시적으로 전송 또는 처리될 수 있으나, 운영자가 분석용
                이미지를 별도 서버에 장기 보관하지 않습니다.
              </li>
              <li>
                사용자가 생성하거나 저장한 포스터, 사진, 영상 및 로컬 운동 기록은
                사용자의 기기 또는 휴대폰 갤러리에 저장됩니다.
              </li>
              <li>
              ...
              <li>
                광고, 결제, 크래시 분석, 앱 사용 분석과 관련하여 외부 서비스가
                처리하는 로그 또는 거래 정보는 각 서비스의 정책 및 법령상 보관
                의무에 따라 일정 기간 보관될 수 있습니다.
              </li>
            </ul>
          </section>
